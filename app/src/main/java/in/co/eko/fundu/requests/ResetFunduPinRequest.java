...
public class ResetFunduPinRequest extends BaseRequest<ResetFunduPinRequest.OnResetFunduPinResults> implements Response.ErrorListener, Response.Listener<JSONObject> {

    private final String TAG = this.getClass().getSimpleName();
    private final Context context;
    private JsonObjectRequest request;
    private String custid, country_shortname, newpin, role;
    private JSONObject object;

    public ResetFunduPinRequest(Context context) {
        super(context);
        this.context = context;
    }
    //    custid,countryShortname,old_pin,new_pin,role
    public void setData(String custid, String country_shortname, String newpin, String role ) {
        this.custid = custid;
    ...
    public void start() {
        ...
        Fog.e("Change FPin API", API.RESET_FUNDU_PIN_API+" \nJson : "+object.toString());
        request = new JsonObjectRequest(Request.Method.POST, API.RESET_FUNDU_PIN_API, object, this, this) {
            @Override
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        if (callback != null) {
            callback.onResetFunduPinError(error);
        }
    }
...
//        }
        if (callback != null) {
            callback.onResetFunduPinResponse(response);
        }
    }

    public interface OnResetFunduPinResults {
        void onResetFunduPinResponse(JSONObject response);

        void onResetFunduPinError(VolleyError error);
    }
