...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
  ...
  public StickyRecyclerHeadersDecoration(StickyRecyclerHeadersAdapter adapter) {
    this(adapter, new DimensionCalculator());
  }

  private StickyRecyclerHeadersDecoration(StickyRecyclerHeadersAdapter adapter,
      DimensionCalculator dimensionCalculator) {
    this(adapter, dimensionCalculator, new HeaderRenderer(),
        new HeaderViewCache(adapter));
  }
  ...
  private StickyRecyclerHeadersDecoration(StickyRecyclerHeadersAdapter adapter, HeaderRenderer headerRenderer, DimensionCalculator dimensionCalculator, HeaderProvider headerProvider,
  ...
  public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
    ...
    for (int i = 0; i < parent.getChildCount(); i++) {
      ...
      boolean hasStickyHeader = mHeaderPositionCalculator.hasStickyHeader(itemView, position);
