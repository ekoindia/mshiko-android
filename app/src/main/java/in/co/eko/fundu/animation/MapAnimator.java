...
public class MapAnimator {
    ...
    static final int GREY = Color.parseColor("#0db0a7");
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        ...
        PolylineOptions optionsBackground = new PolylineOptions().color(FunduApplication.getAppContext().getResources().getColor(R.color.colorPrimary)).width(10).geodesic(true);

        optionsForeground = new PolylineOptions().color(FunduApplication.getAppContext().getResources().getColor(R.color.colorPrimary)).width(10);
        foregroundPolyline = googleMap.addPolyline(optionsForeground);
        for (int z = 0; z < bangaloreRoute.size(); z++) {
            Fog.d("bangaloreRoute",""+bangaloreRoute.get(z));
        ...
        ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), GREY,Color.parseColor("#767676"));
