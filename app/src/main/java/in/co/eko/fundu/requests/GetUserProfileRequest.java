...
/**
 * Created by zartha on 8/21/17.
 */

public class GetUserProfileRequest extends BaseRequest<GetUserProfileRequest.OnUserProfileRequestResult> implements Response.ErrorListener, Response.Listener<JSONObject>  {

    private final String TAG = GetUserProfileRequest.class.getName();
    private JsonObjectRequest request;
    private Context context;

    public GetUserProfileRequest(Context context) {
        super(context);
    ...
    public void start() {
        ...
        Fog.d("Profile API","****"+url+" "+id+" "+id_type);
