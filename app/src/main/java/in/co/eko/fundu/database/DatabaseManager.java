...
public class DatabaseManager extends AppCompatActivity implements OnItemClickListener {
    public static void start(Context context) {
        Intent starter = new Intent(context, DatabaseManager.class);
...
// all global variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button customQuery = new Button(this);
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if(pos!=0){
                    ...
                    Fog.d("selected table name is",""+c.getString(0));
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        tempc.moveToLast();
                                                                        Fog.d("Drop table Mesage",tempc.getString(0));
                                                        ...
                                                        .setPositiveButton("yes",
                                                                new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        Fog.d("delete table query",Query7);
                                                                        ArrayList<Cursor> aldeletet=dbm.getData(Query7);
                                                                        Cursor tempc=aldeletet.get(1);
                                                                        tempc.moveToLast();
                                                                        Fog.d("Delete table Mesage",tempc.getString(0));
                                                                        if(tempc.getString(0).equalsIgnoreCase("Success"))
                                                                        {
                                                                            tvmessage.setBackgroundColor(Color.parseColor("#2ecc71"));
                                ...
                                if(spinnertable.getSelectedItem().toString().equals("Add row to this table"))
                                {
                                    ...
                                    for(int i=0;i<addnewrownames.size();i++)
                                    {
                                        ...
                                        Fog.d("Edit Text Value",""+et.getText().toString());
    ...
    public void updateDeletePopup(int row)
    {
        ...
        for(int i=0;i<columnames.size();i++)
        {
            ...
            et.setTextColor(Color.parseColor("#000000"));
            et.setId(k);
            Fog.d("text View Value","" + tv.getText().toString());
            final LinearLayout ll = new LinearLayout(DatabaseManager.this);
