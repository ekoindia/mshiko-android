...
public class AmountSelectorView extends View {

    private static final String TAG = AmountSelectorView.class.getSimpleName();
    ...
    private static final int DEFAULT_FILLED_COLOR = Color.parseColor("#339933");
    ...
    private static final int DEFAULT_RANGE_COUNT = 21;
    ...
    public AmountSelectorView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public AmountSelectorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AmountSelectorView);
            ...
            try {
                ...
                rangeCount = a.getInt(
                        R.styleable.AmountSelectorView_rangeCount, DEFAULT_RANGE_COUNT);
                filledColor = a.getColor(
                        R.styleable.AmountSelectorView_filledColor, DEFAULT_FILLED_COLOR);
                emptyColor = a.getColor(
                        R.styleable.AmountSelectorView_emptyColor, DEFAULT_EMPTY_COLOR);
                barHeightPercent = a.getFloat(
                        R.styleable.AmountSelectorView_barHeightPercent, DEFAULT_BAR_HEIGHT_PERCENT);
                barHeightPercent = a.getFloat(
                        R.styleable.AmountSelectorView_barHeightPercent, DEFAULT_BAR_HEIGHT_PERCENT);
                slotRadiusPercent = a.getFloat(
                        R.styleable.AmountSelectorView_slotRadiusPercent, DEFAULT_SLOT_RADIUS_PERCENT);
                sliderRadiusPercent = a.getFloat(
                        R.styleable.AmountSelectorView_sliderRadiusPercent, DEFAULT_SLIDER_RADIUS_PERCENT);
            } finally {
                a.recycle();
                sa.recycle();
            }
