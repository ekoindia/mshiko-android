...
public class CircleProgressBar extends ProgressBar {
    ...
    private static final String COLOR_FFD3D3D6 = "#ffe3e3e6";
    ...
    private int mProgressBetweenColor;
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mDrawProgressText = a.getBoolean(R.styleable.CircleProgressBar_draw_progress_text, false);
        ...
        mProgressBetweenColor = a.getColor(R.styleable.CircleProgressBar_progress_between_color, Color.parseColor(COLOR_FFD3D3D6));
