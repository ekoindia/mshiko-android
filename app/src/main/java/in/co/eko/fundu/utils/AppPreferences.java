...
public class AppPreferences {
    ...
    private String setupFullPath(String imageName) {
        ...
        if (isExternalStorageReadable() && isExternalStorageWritable() && !mFolder.exists()) {
            if (!mFolder.mkdirs()) {
                Fog.e("ERROR", "Failed to setup folder");
                return "";
            }
        }
    ...
    /*public  void setArrayList(Context context, String Key,  ArrayList<String> Value){
        Gson gson = new Gson();
    ...
    public  ArrayList<String> getArrayList(Context context, String key){
        ...
        ArrayList<String> alist=gson.fromJson(preferences.getString("",key), type);
        return alist;
    }*/
